...
plot6 = Figure(x_axis_type="datetime", plot_width=800)

x = [1, 2, 3, 4, 5]
y = [6, 7, 2, 4, 5]

def make_plot(title1, plot1, title2, plot2, title3, plot3, title4, plot4, title5, plot5, title6, plot6, sampleSI,x_low,x_high):
    plot1.title = title1
    plot2.title = title2
    plot3.title = title3
    plot4.title = title4
    ...
    plot6.line(x, y, color="navy", line_width=4)
    plot1.x_range=Range1d(start=x_low, end=x_high)
    plot2.x_range=Range1d(start=x_low, end=x_high)
    plot3.x_range=Range1d(start=x_low, end=x_high)
    plot4.x_range=Range1d(start=x_low, end=x_high)
    plot5.x_range=Range1d(start=x_low, end=x_high)
...
plot = make_plot(datas['DO']['name'], plot1, datas['Ammonium']['name'], plot2, datas['pH']['name'], plot3,
                 ...
                 datas['Air Mass Flow Controller']['name'], plot6, sampleSI,x_low,x_high)
...
def update():
    ...
    plot = make_plot(datas['DO']['name'], plot1,
                    datas['Ammonium']['name'], plot2, datas['pH']['name'], plot3,
                     datas['N2 Mass Flow Controller']['name'], plot4, datas['Air Mass Flow Controller']['name'], plot5,
                     datas['Air Mass Flow Controller']['name'], plot6, sampleSI,x_low,x_high)
